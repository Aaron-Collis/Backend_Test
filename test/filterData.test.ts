import { DATE_TIME_FILTER } from "../src/config";
import { filterAndAttachOutageData } from "../src/filterData";
import { Outages, SiteInfo } from "../src/models";

describe("Test filterAndAttachOutageData", () => {
  test("No outages and no devices return empty array", () => {
    ...
    const enhancedData = filterAndAttachOutageData(DATE_TIME_FILTER, outages, sites);
